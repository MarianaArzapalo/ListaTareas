const Tareas = ({todo, handleSetCompleted, handleDelete}) => {
        ...
        <div className="flex items-center">
          {
            completed?(
              ...
              <span onClick={() => handleSetCompleted(id)} className="border-solid border border-gray-500 rounded-full p-3 cursor-pointer">
